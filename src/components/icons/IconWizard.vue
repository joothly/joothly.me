...
.star {
  ...
  pointer-events: none;
  opacity: 0;
  filter: hue-rotate(270deg) saturate(1.5) brightness(1.1) drop-shadow(0 0 4px rgba(91, 76, 197, 0.8));
  left: 50%;
  top: 50%;
...
.wizard-container:hover .star {
  animation: spawn-star 1s ease-out forwards;
}
...
.wizard-container:hover .star-4 {
  animation-delay: 0.3s;
}

@keyframes spawn-star {
  0% {
    opacity: 1;
